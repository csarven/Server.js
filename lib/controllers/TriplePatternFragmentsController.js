...
TriplePatternFragmentsController.prototype._getViewName = function() {
    return 'TriplePatternFragments';
};
...
TriplePatternFragmentsController.prototype._handleRequest = function (request, response, next) {
  ...
  var view = this._negotiateView(this._getViewName(), request, response),
